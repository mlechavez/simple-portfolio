...
const Hero = () => {
  ...
  return (
    <div className="hero h-100">
      ...
      <p>
        I am the Lead of the Custom App pod. We are composed of 5 different projects. I help the team grow by supporting them and provide the right trainings and advices.
      </p>
      <motion.button
